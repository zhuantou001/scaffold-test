...
<script>
  ...
  export default {
    ...
    data () {
      return {
        index: 3,
        button_font: this.$store.state.button.buttonObject.buttonFont,
        button_color: this.$store.state.button.buttonObject.buttonColor,
        button_object: {buttonFont: this.$store.state.button.buttonObject.buttonFont, buttonColor: this.$store.state.button.buttonObject.buttonColor}
      };
    },
    methods: {
      deleteFun () {
