...
<script>
  ...
  export default {
    ...
    data () {
      return {
        index: 4,
        words_content: this.$store.state.button.wordsObject.wordsContent,
        words_color: this.$store.state.button.wordsObject.wordsColor,
        words_para: this.$store.state.button.wordsObject.wordsPara,
        words_object: {wordsContent: this.$store.state.button.wordsObject.wordsContent, wordsColor: this.$store.state.button.wordsObject.wordsColor, wordsPara: this.$store.state.button.wordsObject.wordsPara},
        options: [{
          value: 'center',
          label: '居中'
        }, {
