<template>
  <span>
    <el-button type="success" @click="save">填写页保存</el-button>
...
<script>
  import {submitFillData, obtainFillData, scaffoldData, successMsg, failMsg} from '../common/common';
