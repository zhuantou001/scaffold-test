 <template>
  <div>
    ...
    <ul class="fill-list line35">
      ...
      <li :class="{error:errorItem === 'certId'}" hidden>
      ...
      <li :class="{error:errorItem === 'contractPhone'}">
        ...
        <div class="p-content">
          <!-- <span v-if="radioPerInfo === 2" class="user-message"></span> -->
          <input v-model.trim='contractPhone' type="tel" title="联系电话" placeholder="请输入联系电话" maxlength="11"/>
        </div>
      </li>
    </ul>
    <ul class="fill-list line36">
      <li id="delivery" @click="openChooseDis" :class="{error:errorItem === 'chooseAdd'}">
        <div class="p-title">安装地址</div>
